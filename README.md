...
- **Real-table wager timing** — the moment cards are dealt, the bet **leaves your balance** (the HUD shows the deducted figure; doubles and splits deepen it live), and the settle credits stake + result. Closing or refreshing mid-hand behaves exactly like walking away from a live table: a dealt hand you never played is **forfeited**, but once you've hit, doubled, or split, an exit handler **stands your hand, plays out the dealer in the background, and writes the settled balance** to the save — no free take-backs, no lost wins.
